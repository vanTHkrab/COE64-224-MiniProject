...
// =========================
// ADD THIS TO FETCH CROP TYPES
// =========================

export function CropSelect({ selectedCrop, setSelectedCrop }) {
  ...
  React.useEffect(() => {
    const fetchCropTypes = async () => {
      try {
        ...
        const uniqueCrops = [...new Set(data.map((item) => item.plant))];
      ...
      <Select value={selectedCrop} onValueChange={setSelectedCrop}>
        ...
        <SelectContent>
          {cropTypes.length > 0 ? (
              ...
              <SelectItem key="no-crop" value="" disabled>
                No crops available
              </SelectItem>
          )}
        </SelectContent>
